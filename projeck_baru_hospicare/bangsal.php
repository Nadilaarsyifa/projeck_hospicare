...
LEFT JOIN tb_kelaskamar ON tb_kelaskamar.kategori = tbbaru.kategori where kode='lll'");
while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}

$select_kategori = mysqli_query($conn, "SELECT kategori from tb_kelaskamar where kode='lll'");
?>
